...
|---|---|---|
| this package, **matchlen SIMD** | **~4.0 GB/s** | **~1.9x** |
| this package, scalar match-count | ~2.15 GB/s | 1.0x |
| `pierrec/lz4` (reference, tuned) | ~5.3 GB/s | — |

So the SIMD common-prefix primitive **nearly doubles encode throughput** here.
